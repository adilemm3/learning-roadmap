# Algorithms & Data Structures — Обзор

## Что это
Алгоритмы и структуры данных — сложность, сортировки, деревья, графы, динамическое программирование. Фундаментальные знания для написания эффективного кода и прохождения технических собеседований.

## Подтемы
| # | Подтема | Описание |
|---|---------|----------|
| 1 | Complexity & Big O | Нотация Big O, анализ сложности, amortized analysis |
| 2 | Sorting & Searching | Алгоритмы сортировки, бинарный поиск |
